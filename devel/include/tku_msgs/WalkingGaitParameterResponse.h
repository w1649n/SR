// Generated by gencpp from file tku_msgs/WalkingGaitParameterResponse.msg
// DO NOT EDIT!


#ifndef TKU_MSGS_MESSAGE_WALKINGGAITPARAMETERRESPONSE_H
#define TKU_MSGS_MESSAGE_WALKINGGAITPARAMETERRESPONSE_H
...
struct WalkingGaitParameterResponse_
{
  typedef WalkingGaitParameterResponse_<ContainerAllocator> Type;

  WalkingGaitParameterResponse_()
    : X_Swing_Range(0.0)
    , Y_Swing_Range(0.0)
    , Z_Swing_Range(0.0)
    , Period_T(0)
  ...
  WalkingGaitParameterResponse_(const ContainerAllocator& _alloc)
    : X_Swing_Range(0.0)
    , Y_Swing_Range(0.0)
    , Z_Swing_Range(0.0)
    , Period_T(0)
  ...
  typedef boost::shared_ptr< ::tku_msgs::WalkingGaitParameterResponse_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::tku_msgs::WalkingGaitParameterResponse_<ContainerAllocator> const> ConstPtr;

}; // struct WalkingGaitParameterResponse_

typedef ::tku_msgs::WalkingGaitParameterResponse_<std::allocator<void> > WalkingGaitParameterResponse;

typedef boost::shared_ptr< ::tku_msgs::WalkingGaitParameterResponse > WalkingGaitParameterResponsePtr;
typedef boost::shared_ptr< ::tku_msgs::WalkingGaitParameterResponse const> WalkingGaitParameterResponseConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::tku_msgs::WalkingGaitParameterResponse_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::tku_msgs::WalkingGaitParameterResponse_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::tku_msgs::WalkingGaitParameterResponse_<ContainerAllocator1> & lhs, const ::tku_msgs::WalkingGaitParameterResponse_<ContainerAllocator2> & rhs)
{
  return lhs.X_Swing_Range == rhs.X_Swing_Range &&
...
template <class ContainerAllocator>
struct IsFixedSize< ::tku_msgs::WalkingGaitParameterResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::tku_msgs::WalkingGaitParameterResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::tku_msgs::WalkingGaitParameterResponse_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::tku_msgs::WalkingGaitParameterResponse_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::tku_msgs::WalkingGaitParameterResponse_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::tku_msgs::WalkingGaitParameterResponse_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::tku_msgs::WalkingGaitParameterResponse_<ContainerAllocator> >
{
  ...
  static const char* value(const ::tku_msgs::WalkingGaitParameterResponse_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xfd1d02fd4315b5dfULL;
  static const uint64_t static_value2 = 0x1d63c8d0302c7939ULL;
};

template<class ContainerAllocator>
struct DataType< ::tku_msgs::WalkingGaitParameterResponse_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::tku_msgs::WalkingGaitParameterResponse_<ContainerAllocator> >
{
  static const char* value()
  {
    return "float32 X_Swing_Range\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::tku_msgs::WalkingGaitParameterResponse_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::tku_msgs::WalkingGaitParameterResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::tku_msgs::WalkingGaitParameterResponse_<ContainerAllocator>& v)
  {
...
#endif // TKU_MSGS_MESSAGE_WALKINGGAITPARAMETERRESPONSE_H
