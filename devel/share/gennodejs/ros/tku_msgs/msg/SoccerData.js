...
class SoccerData {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int32(obj.object_mode, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.object_mode = _deserializer.int32(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SoccerData(null);
    if (msg.x !== undefined) {
      resolved.x = msg.x;
    }
    else {
