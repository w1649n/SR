...
class Parameter_message(genpy.Message):
  _md5sum = "c271258ea4c66c2bc743bcfb6b19e260"
...
float32 Support_Foot_Ankle_Upper_Pitch"""
  ...
  _slot_types = ['int32','float64','float64','float64','int32','int32','int32','float64','float64','int32','float64','float64','bool','tku_msgs/B_SplineParam']
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_i3d3i2di2dB8f = None
def _get_struct_i3d3i2di2dB8f():
    global _struct_i3d3i2di2dB8f
    if _struct_i3d3i2di2dB8f is None:
        _struct_i3d3i2di2dB8f = struct.Struct("<i3d3i2di2dB8f")
    return _struct_i3d3i2di2dB8f
